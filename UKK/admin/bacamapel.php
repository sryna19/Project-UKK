	...
	<main>
		<section class="content">
			<div class="col-1">
				...
				<hr>
				<center><button name="tambah" onclick="location.href='tambahmapel.php'">Tambah Data</button></center>
				<br>
				<table border='1' cellspacing="0" cellpadding='5' style="width: 100%;">
					...
					?>
						<tr>
							...
							<td>
								<a href="editmapel.php?id=<?php echo "$data[id_m]"; ?>">EDIT</a> |
								<a href="hapusmapel.php?id=<?php echo "$data[id_m]"; ?>" onclick="return confirm('Anda yakin?')">HAPUS</a>
							</td>
						</tr>
					<?php
						$no++;
