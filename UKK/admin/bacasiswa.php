	...
	<main>
		<section class="content">
			<div class="col-1">
				...
				<hr>
				<center><input type="button" value="Tambah Data" onclick="location.href='tambahsiswa.php'"></center>
				<br>
				<table border='1' cellspacing="0" cellpadding='5'>
					...
					?>
						<tr>
							...
							<td>
								<a href="tambahnilais.php?id=<?php echo "$data[idsiswa]"; ?>">TAMBAH</a> |
								<a href=" editsiswa.php?id=<?php echo "$data[idsiswa]"; ?>">EDIT</a> |
								<a href="hapussiswa.php?id=<?php echo "$data[idsiswa]"; ?>" onclick="return confirm('Anda yakin?')">HAPUS</a>
							</td>
						</tr>
					<?php
						$no++;
