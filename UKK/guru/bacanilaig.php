...
<body>
    ...
    <main>
        <section class="content">
            <div class="col-1">
                <h2>Haloo ,<?php echo $_SESSION['namaguru']; ?></h2>
                <h2>Nilai</h2>
                <hr>
                <br>
                <table border='1' cellspacing="0" cellpadding='5'>
                    ...
                    $id = $_GET['id'];
                    $no = 1;
                    $sql = "SELECT * FROM nilai,siswa,guru WHERE nilai.nip=guru.nip AND nilai.nisn=siswa.nisn AND guru.nip='$_GET[id]' ORDER BY idnilai ASC";
