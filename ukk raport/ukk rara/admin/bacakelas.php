		...
		<section class="content">
			<div class="col-1">
				...
				<table border='1' cellspacing="0" cellpadding='5'>
					...
					<?php
					$no = 1;
					$sql = "SELECT * FROM kelas ORDER BY namakelas ASC";
					...
					?>
						<tr>
							...
							<td>
								<a href="editkelas.php?id=<?php echo "$data[idkelas]"; ?>">EDIT</a> |
								<a href="hapuskelas.php?id=<?php echo "$data[idkelas]"; ?>" onclick="return confirm('Anda yakin?')">HAPUS</a>
							</td>
						</tr>
					<?php
						$no++;
