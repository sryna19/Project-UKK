	...
	<main>
		<section class="content">
			...
			<div class="column">
				<h2>Tentang Web</h2>
				<p>
					Web ini berfungsi untuk melihat, mengubah, serta menambahkan data untuk siswa, guru, kelas, jurusan, dan juga mapel.
					Web ini juga berfungsi untuk menginput data nilai dari siswa
				</p>
			</div>
		</section>
	</main>
